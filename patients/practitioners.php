        ...
        <div class="row pt-4 ">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-3 pt-4 ">
                <div
                    ...
                    <h3><i class="bi bi-journal-medical"></i> All Practitioners</h3>
                </div>
                    ...
                    <div class="row mt-3">
                        <?php
                            if(!isset($_GET['search'])){
                                ...
                                $keyword = $_GET['search'];
                                $sql = "SELECT * FROM `practitioner`  WHERE (`fname` LIKE '%".$keyword."%') 
                                OR (`lname` LIKE '%".$keyword."%') 
                                OR (`professionality` LIKE '%".$keyword."%') AND (`verified` = 1)";
                            }
                            $resultset = mysqli_query($conn, $sql);	
                            if(mysqli_num_rows($resultset)==0){
                                echo '<h5 class="text-center text-info">';
